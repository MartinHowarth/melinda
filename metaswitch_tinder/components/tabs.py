...
def generate_tabs(
    tabs: Dict[str, html.Div], default_tab: html.Div, tabs_id: str, display_id: str
) -> html.Div:
    """
    ...
    """
    formatted_dict = [{"label": key, "value": value} for key, value in tabs.items()]

    return html.Div(
        [
            dcc.Tabs(tabs=formatted_dict, value=default_tab, id=tabs_id),

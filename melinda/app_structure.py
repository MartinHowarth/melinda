...
from melinda import app_globals
from melinda.components.session import is_logged_in
...
def generate_structure():
    ...
    from melinda.pages import (  # noqa
        easter,
        user_menu,
        signup,
        mentee_landing_page,
    ...
    from melinda.tabs import open_requests
    from melinda.components import auth, debug_login  # noqa
